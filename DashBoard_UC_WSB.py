...
#                     {'label': 'White', 'value': 'White'},
#                     {'label': 'Yampa', 'value': 'Yampa'},
#                     {'label': 'Upper Colorado', 'value': 'Upper Colorado'},
#                     {'label': 'San Juan & Dolores', 'value': 'San Juan & Dolores'}
#                 ],
#                 value='Gunnison',
#                 clearable=False,
#                 style={
...
# # --- Callbacks ---
# @app.callback(Output('streamflow-plot', 'figure'),
#               [Input('district-dropdown', 'value'),
#                Input('year-dropdown', 'value')])
# def update_streamflow(district, year):
#     fig = get_loader(district)['plot_streamflow'](year)
...
# @app.callback(Output('shortage-plot', 'figure'),
#               [Input('district-dropdown', 'value'),
#                Input('year-dropdown', 'value')])
# def update_shortage(district, year):
#     fig = get_loader(district)['sector_water_use_shortage_plot'](year)
...
# @app.callback(Output('drought-map', 'figure'),
#               [Input('district-dropdown', 'value'),
#                Input('year-dropdown', 'value')])
# def update_drought_map(district, year):
#     fig = get_loader(district)['plot_drought_map'](year)
...
# @app.callback(Output('reservoir-plot', 'figure'),
#               [Input('district-dropdown', 'value'),
#                Input('year-dropdown', 'value')])
# def update_reservoir(district, year):
#     fig = get_loader(district)['plot_storage'](year)
...
app.layout = html.Div([
    html.H1(
        "Hydrologic and Drought Analysis in the Upper Colorado River Basin (1909–2013)",
        style={
            'textAlign': 'center',
            'fontSize': '30px',
            'fontFamily': 'Arial, sans-serif',
